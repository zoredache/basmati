...
// variable in basmaticonstants.php is set to a value of 1.
// 
// You should rename this file from "example_facultyplugins.php" to "facultyplugins.php"
// so that CVS updates do not overwrite your settings.
