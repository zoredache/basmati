...
// +----------------------------------------------------------------------+
//
// $Id: getpasswords.php,v 1.1 2001/09/22 22:18:00 basmati Exp $
 ...
 if ($reporttype != "GMIMPORT" ){
  ...
  $mysql_query  = "SELECT PERSONAL.sid, last, first, password, GMSCORES.grade as Score from PERSONAL left join GMSCORES on PERSONAL.sid = GMSCORES.sid where GMSCORES.cc = '" . $cc . "' and PERSONAL.schoolid = '" . $SchoolID . "';";
 } else {
   ...
   $mysql_query  = "SELECT DISTINCT PERSONAL.sid, password from PERSONAL left join GMSCORES on PERSONAL.sid = GMSCORES.sid where GMSCORES.cc = '" . $cc . "' and PERSONAL.schoolid = '" . $SchoolID . "';";
 }
